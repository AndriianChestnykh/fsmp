    ...
    function getBuyOrder(index, boLength) {
      ...
      promise.then((gboArr) => {
        ...
        let gbo = {
          id: +gboArr[0],
          DO: gboArr[1],
          DOShort: gboArr[1].toString().substring(1, 10),
    ...
    function getSellOrder(index, soLength) {
      ...
      promise.then((soArr) => {
        let so = {
          id: +soArr[0],
          DO: soArr[1],
          DOShort: soArr[1].toString().substring(1, 10),
    ...
    function getStorageContract(index) {
      ...
      promise.then((scArr) => {
        let sc = {
          id: +scArr[0],
          DOAddress: scArr[1],
          DOAddressShort: scArr[1].toString().substring(1, 10),
          DSOAddress: scArr[2],
          DSOAddressShort: scArr[2].toString().substring(1, 10),
